...
public class ListRecyclerViewAdapter extends RecyclerView.Adapter<ListRecyclerViewAdapter.ListViewHolder> {
    ...
    private void updateCheckBox(ListViewHolder holder, boolean isChecked) {
        if (isChecked) {
            holder.imageView.setImageDrawable(ContextCompat.getDrawable(mContext, R.drawable.ic_star_24dp));
        } else {
            holder.imageView.setImageDrawable(ContextCompat.getDrawable(mContext, R.drawable.ic_star_border_24dp));
        }
    }
}
